let addListButton = document.querySelector(".add_button");
let addListAddButton = document.querySelector("#add_list_button");
let addListBackButton = document.querySelector("#back_list_button");
let mainContainer = document.querySelector(".middle_container");
let taskArray = [];
let addListTextBox = document.querySelector("#add_new_textbox")
